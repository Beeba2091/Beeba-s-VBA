...
' Iterate through each worksheet
        ...
        For rowCounter = 2 To lastRow
            ...
            ' find the percentChange, yearChange and conditionally formats the values under yearChange
            ...
            If (ws.Cells(rowCounter - 1, 1).Value = ws.Cells(rowCounter, 1).Value And ws.Cells(rowCounter + 1, 1).Value <> ws.Cells(rowCounter, 1).Value) Then
               ...
               Else
                    ...
                    ' calculate percent change, normally we multiply by 100 but we will add % and * 100 when displaying the value
            ...
            End If
                ...
                'find the total volume per ticker
        ...
        ' Find the greatest increase, greatest decrease, and greatest volume comparison
        ...
        ' For loop for the final results
        For resultsCounter = 2 To lastRow
            ...
            If ws.Cells(resultsCounter, 11).Value > ws.Cells(2, 17).Value Then
                ...
                ' find the greatest value and print it to the results table
            ...
            If ws.Cells(resultsCounter, 11).Value < ws.Cells(3, 17).Value Then
             ...
             'find Store the new temporaty percent change value in cell (3,17)
